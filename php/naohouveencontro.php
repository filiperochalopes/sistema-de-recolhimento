...
$assunto = "NÃO HOUVE ENCONTRO [$ic]";
$mensagem = "Prezado irmão,<br><br>O grupo caseiro $ic, cujos líderes $lideres são responsáveis na Igreja em $cidade informa que não houve reunião da Igreja na casa essa semana e, portanto não houve recolhimentos.<br><br>Saudações,<br><br> Responsáveis. <br> $data";
